...
The core of the algorithm is the _extended dynamic mode decomposition_ (EDMD). A technique that follows several other types of the decompositions, and that shows a remarkable power to identify dynamical systems in general, regardless of the (possibly) nonlinear behavior of the system to identify or analyze.
